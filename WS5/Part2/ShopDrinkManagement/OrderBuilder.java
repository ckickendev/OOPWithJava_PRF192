...
public class OrderBuilder {
    public OrderedItems preparePizza(){
        ...
        System.out.println("============================");
        int pizzaandcolddrinkchoice = Integer.parseInt(br.nextLine());
        switch (pizzaandcolddrinkchoice){
            case 1:{
                ...
                System.out.println("    3.Malasa Pizza");
                System.out.println("    4.Exit");
                System.out.println("------------------------------ ");
                int vegpizzachoice = Integer.parseInt(br.nextLine());
                switch (vegpizzachoice){
                    case 1:{
                        ...
                        System.out.println("------------------------------------ ");
                        int cheezepizzasize = Integer.parseInt(br.nextLine());
                    ...
                    case 2:{
                        ...
                        System.out.println("------------------------------------ ");
                        int onionpizzasize = Integer.parseInt(br.nextLine());
                    ...
                    case 3:{
                        ...
                        System.out.println("------------------------------------ ");
                        int masalapizzasize = Integer.parseInt(br.nextLine());
            ...
            case 2:{
                ...
                System.out.println("------------------------------------");
                int nonvegpizzasize = Integer.parseInt(br.nextLine());
        ...
        System.out.println(" 3. Exit ");
        System.out.println("============================");
        int coldDrink = Integer.parseInt(br.nextLine());
        switch (coldDrink){
            case 1:{
                ...
                System.out.println("------------------------");
                int pepsisize = Integer.parseInt(br.nextLine());
                switch (pepsisize){
                    case 1:{
            ...
            case 2:{
                ...
                System.out.println("------------------------");
                int cokesize = Integer.parseInt(br.nextLine());
                switch (cokesize){
                    case 1:{
